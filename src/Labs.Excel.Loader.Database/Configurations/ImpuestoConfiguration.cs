...
{
    public class ImpuestoConfiguration : IEntityTypeConfiguration<c_Impuesto>
    {
        public void Configure(EntityTypeBuilder<c_Impuesto> builder)
        {
            builder.ToTable("c_Impuesto");
